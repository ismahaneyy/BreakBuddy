...
//         <h1 className="text-3xl my-auto tracking-wider font-serif bg-white w-2/5 p-3 mx-auto rounded-2xl shadow-md mr-3">
//           MJ Rooms
//         </h1>
...
//           users online: {userNo}
//         </h3>
//         <div className="bg-white w-18 flex flex-col p-4 space-y-8 rounded-lg shadow-2xl">

//           <button
//           type="button"
//           onClick={handleMicClick}
//           className="p-2 bg-red-400  text-white rounded-full ml-2"
//         >
//           {micOn ? <FaMicrophone /> : <FaMicrophoneSlash />}
//         </button>
//           <button onClick={disconnectUser} className="exit mx-auto"><RxExit size={20} /></button>
//         </div>
//         <button 
